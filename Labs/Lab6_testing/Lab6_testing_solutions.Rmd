...
In this lab, we will look at hypothesis testing, as applied to the detection of differentially expressed genes from RNA-Seq data, using the `DESeq2` package.
We will focus on the main, fundamental issues around such "multiple testing" scenarios.
These will also apply to other data types and data sets.
...
install_if_needed(c("dplyr", "ggplot2", "readr", "tibble", 
                "DESeq2", "apeglm", "pasilla", "genefilter",
                "pheatmap"))
```
