...
**Answer**: `t()` transposes the expression matrix `Morder`
...
**Answer**: We see 3 clusters at the height of 12:
...
**Answer**: 4616, as we can read off from the previous `table` call or by:
