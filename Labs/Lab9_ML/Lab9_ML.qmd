...
our prediction rule on each of them. On top of this, we also plot the class 
centers. Assembling this visualization requires us to write a bit of code, but 
don't worry too much if you don't understand it - we do this just to illustrate 
the concepts.
